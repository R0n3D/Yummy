...
INSERT INTO customers(customerNumber,customerName,
      ...
      creditLimit) 
VALUES 
(112,'Signal Gift Stores','King','Jeyan','7025551838',
'8489 Strong St.','Las Vegas','NV','83030','USA',1166,
71800.00);

-- OPTION3 - the fields are not in the original order , and
-- the values are ordered accordingly
INSERT INTO customers(country,salesRepEmployeeNumber,
     customerNumber,customerName,
      addressLine1,addressLine2,city,state,
      contactLastName,contactFirstName,phone,
      postalCode,creditLimit) 
VALUES 
('Australia',1611,114,'Australian Collectors, Co.',
'636 St Kilda Road','Level 3','Melbourne','Victoria',
'Ferguson','Peter','03 9520 4555',
'3004',117300.00);

-- OPTION4 - without pointing out the fields -
--    needs all the values in their original order
--   (use NULL where needed)
INSERT INTO customers 
VALUES 
(119,'La Rochelle Gifts','Labrune','Janine ','40.67.8555',
'67, rue des Cinquante Otages',NULL,'Nantes',NULL,'44000',
'France',1370,118200.00);

-- OPTION5 - Any of the previous options together with
-- several rows of VALUES - MULTI-INSERT
INSERT INTO customers 
VALUES 
